...
void SynthSection::paintSidewaysHeadingText(Graphics& g) {
  ...
  g.addTransform(AffineTransform::rotation(-davis::kPi / 2.0f));
...
//  davis::ValueDetails hz_details = *slider->getDisplayDetails();
//  hz_details.value_scale = davis::ValueDetails::kExponential;
//  hz_details.post_offset = 0.0f;
//  hz_details.display_units = " Hz";
//  hz_details.display_multiply = davis::kMidi0Frequency;
