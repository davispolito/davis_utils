...
void PopupList::renderOpenGlComponents(OpenGlWrapper& open_gl, bool animate) {
  ...
  float image_width = davis::utils::nextPowerOfTwo(getWidth());
  float image_height = davis::utils::nextPowerOfTwo(rows_->getImageHeight());
...
//
//  float image_width = davis::utils::nextPowerOfTwo(getWidth());
//  float image_height = davis::utils::nextPowerOfTwo(row_height);
//  float width_ratio = image_width / getWidth();
