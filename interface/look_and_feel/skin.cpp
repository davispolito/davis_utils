...
//        FileChooser open_box("Open Skin", File(), String("*.") + davis::kSkinExtension);
...
//        FileChooser save_box("Save Skin", File(), String("*.") + davis::kSkinExtension);
//        if (save_box.browseForFileToSave(true))
//          skin_->saveToFile(save_box.getResult().withFileExtension(davis::kSkinExtension));
