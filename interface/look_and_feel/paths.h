...
//    }
    ...
    static Path clock() {
      ...
      Path path;
      path.addPieSegment(kBuffer, kBuffer, kClockWidth, kClockWidth, 0.0f, kClockAngle - 2.0f * davis::kPi, 0.0f);
...
//    }
    ...
    static Path magnifyingGlass() {
      ...
      path.addLineSegment(Line<float>(1.0f, 1.0f, 1.0f, 1.0f), 0.2f);
      float diameter = 2.0f * kRadius;
      path.addPieSegment(kGlassOffset, kGlassOffset, diameter, diameter, 0.0f, 2.0f * davis::kPi, 1.0f - kWidthRatio);
