...
#include <davis_look_and_feel/davis_look_and_feel.h>
namespace davis {
    OpenGlMultiImage::OpenGlMultiImage(int max_quads) : image_(nullptr), image_width_(0), image_height_(0),
                                                        ...
                                                        dirty_(false), additive_blending_(false),
    ...
    void OpenGlMultiImage::init(OpenGlWrapper &open_gl) {
        ...
        open_gl.context.extensions.glBufferData(juce::gl::GL_ELEMENT_ARRAY_BUFFER, tri_size, indices_.get(),
                                                juce::gl::GL_STATIC_DRAW);
