...
namespace davis {
    ...
    void OpenGlBackground::init(OpenGlWrapper &open_gl) {
        ...
        open_gl.context.extensions.glBufferData(juce::gl::GL_ARRAY_BUFFER, vert_size, vertices_,
        ...
        open_gl.context.extensions.glBufferData(juce::gl::GL_ELEMENT_ARRAY_BUFFER, tri_size, triangles,
                                                juce::gl::GL_STATIC_DRAW);
