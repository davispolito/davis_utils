...
namespace davis {
    ...
    OpenGlMultiQuad::OpenGlMultiQuad(int max_quads, Shaders::FragmentShader shader, juce::String name)
    ...
    void OpenGlMultiQuad::render(OpenGlWrapper &open_gl, bool animate) {
        ...
        if (background_color_uniform_) {
            if (background_color_.getFloatAlpha()) {
                ...
                background_color_uniform_->set(color_.getFloatRed(), color_.getFloatGreen(), color_.getFloatBlue(),
                                               0.0f);
        }
        ...
        juce::gl::glDrawElements(juce::gl::GL_TRIANGLES, num_quads_ * kNumIndicesPerQuad, juce::gl::GL_UNSIGNED_INT,
                                 nullptr);
